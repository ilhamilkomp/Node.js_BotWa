const sessionName = "Ikomp2";
const donet = "Jangan Lupa Support Ngab Biar Bot nya Online Terus";
const owner = ["6285363221272"]; // Put your number here ex: ["62xxxxxxxxx"]
const {
...
async function startHisoka() {
  ...
  client.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
      ...
      client.sendMessage(owner + "@s.whatsapp.net", { text: `Kekuatan SuperKu Di Mulai!\n\njangan lupa support ya bang :)\n${donet}` });
    }
